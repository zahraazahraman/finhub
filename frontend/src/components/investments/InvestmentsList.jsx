...
export default function InvestmentsList({ investments, hasFilters = false, onSelectInvestment, onAddInvestment, onDeleteInvestment }) {
  ...
  if (investments.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 animate-fade-in">
        ...
        {hasFilters ? (
          <>
            <h3 className="text-skin-text font-semibold text-base mb-1">No matching investments</h3>
