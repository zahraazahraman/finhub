        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-8 mt-10">
            {[
              ...
              <div key={stat.label}>
                <div className="text-2xl font-bold text-skin-text">{stat.value}</div>
                <div className="text-xs text-skin-text-muted mt-0.5">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
                  ...
                  <div
                    ...
                    className={`
                      ...
                      ${rememberMe
                        ...
                        : "bg-transparent border-skin-border group-hover:border-emerald-500/50"
                      }
                    `}
                  >
                    {rememberMe && (
